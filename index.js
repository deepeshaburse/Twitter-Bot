...
// authenticated client for this app
...
// authenticated client for bot user
...
async function main() {
    ...
    if(mode > 0.5) {
        reducedHours = 1
        userList = process.env.USER_SECOND_LIST
    }
}
...
const {meta, data, includes} = app.get('tweets/search/recent', params)
